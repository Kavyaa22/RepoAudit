...
from repoaudit.indexing.wiki.builder import Wiki
...
<div class="sidebar">
  ...
  <div style="margin-top: 24px; padding-top: 12px; border-top: 1px solid #e5e7eb;
    ...
    Generated by <a href="https://github.com/he-yufeng/RepoAudit" style="color:#6b7280">RepoAudit</a>
  </div>
</div>
