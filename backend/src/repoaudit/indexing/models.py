"""data models for repoaudit analysis pipeline."""
...
class WikiData(BaseModel):
    ...
    structure_audit: FolderStructureAuditResult | None = None
    dead_code_audit: DeadCodeAuditResult | None = None
    security_audit: SecurityAuditResult | None = None
