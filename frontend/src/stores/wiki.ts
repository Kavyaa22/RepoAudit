...
export const useWikiStore = create<WikiStore>()(
  persist(
    (set) => ({
      ...
      loading: false,
      error: "",
      settings: { apiKey: "", model: "gemini-flash-lite", language: "en" },
      ...
      appendToLastChat: (text) =>
        set((s) => {
          ...
          return { chatMessages: [...msgs, { role: "assistant", content: text }] };
        }),
