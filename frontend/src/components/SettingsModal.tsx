      ...
      <div className="bg-white rounded-xl shadow-xl p-6 w-full max-w-md" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                localStorage.setItem("repoaudit_api_key", e.target.value);
              }}
              placeholder="sk-..."
          ...
          <div>
            ...
            >
              <option value="gemini-flash-lite">Gemini 2.5 Flash Lite</option>
              <option value="gemini-flash">Gemini 2.5 Flash</option>
              <option value="deepseek">DeepSeek V3.2</option>
              <option value="openrouter/deepseek/deepseek-chat">OpenRouter (DeepSeek Chat)</option>
              <option value="openrouter/anthropic/claude-3.7-sonnet">OpenRouter (Claude 3.7 Sonnet)</option>
